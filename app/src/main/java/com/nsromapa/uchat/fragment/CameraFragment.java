...
import com.nsromapa.uchat.cameraUtils.AutoFitTextureView;
...
public class CameraFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.frag_camera_capture_btn).setOnClickListener(this);
...
//        view.findViewById(R.id.complete_camera_layout).setOnDragListener(new View.OnDragListener() {
//            @Override
...
//        });
        ...
        picture = view.findViewById(R.id.frag_camera_capture_btn);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getExternalFilesDir("/Images/Captured/"), "UChatNewImage.jpg");
    }
...
//                    showToast("Saved: " + mFile);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.frag_camera_capture_btn: {
                takePicture();
                break;
            }
    ...
    private String getVideoFilePath(Context context) {
        final File dir = context.getExternalFilesDir("/Videos/Captured");
