...
public class BackgroundTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        }else if (params[0].equals("friends_db") || params[0].equals("followers_db")|| params[0].equals("following_db")){
            String tablename="";
            if (params[0].equals("friends_db")){
                tablename = DBObjects.DBHelperObjects.FRIENDS_TABLE_NAME;
            }else if (params[0].equals("followers_db")){
                tablename = DBObjects.DBHelperObjects.FOLLOWERS_TABLE_NAME;

            }else if (params[0].equals("following_db")){
        ...
        }else if (params[0].equals("message_db")){
